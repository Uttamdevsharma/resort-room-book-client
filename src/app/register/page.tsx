        ...
        <div className="relative w-full max-w-md">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="mt-5 text-3xl font-extrabold text-foreground tracking-tight font-display">Create Account</h1>
              <p className="mt-2 text-base text-muted-foreground font-medium">Join CoxBay Resort for exclusive benefits</p>
            </div>
          ...
          <div className="mt-6 animate-fade-up" style={{ animationDelay: "320ms" }}>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 text-sm font-medium bg-background border border-border rounded-xl hover:bg-muted transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background"
            >
              <svg
                className="h-5 w-5"
                aria-hidden="true"
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground pt-7 border-t border-border animate-fade-up" style={{ animationDelay: "350ms" }}>
